...
public class db {
   ...
   public void select (String dbCmd)
    ...
    public void sample2 ()
    {
        ...
        this.update("insert into instruction (id, userInstruction, IRInstruction) value (\"lgAircondition1Aircondition_Power_On\", \"Aircondition_Power_On\", \"880094D\");");
        this.update("insert into instruction (id, userInstruction, IRInstruction) value (\"lgAircondition1Aircondition_Power_Off\", \"Aircondition_Power_Off\", \"88C0051\");");
        ...
        this.update("insert into device_instruction (deviceId, instructionid) value (\"lgAircondition1\", \"lgAircondition1Aircondition_Power_On\");");
        this.update("insert into device_instruction (deviceId, instructionid) value (\"lgAircondition1\", \"lgAircondition1Aircondition_Power_Off\");");
        ...
        this.update("insert into custominstruction (familyid, deviceid, userinstruction, irinstruction) value (\"hanjo\", \"samsungTv1\", \"TV_Blue\", \"E0E06897\");");
