                    ...
                    if (d.getRs().next())
                    {
                        ...
                        try
                        {
                            ...
                            if (d.getRs().next())
                            {
                                ...
                                //Socket s = new Socket ("192.168.137.203", 15150);
                                        ...
                                        if (d.getRs().next())
                                        {
                                            ...
                                            while (d.getRs().next())
                                            {
                                                ...
                                                if (ud.getAuthority().equals("receive"))
                                                {
                                                    ...
                                                    info.put("title", "Inome Smart Doorlock Open Alarm");
                                                    info.put("body", "Smart Doorlock Open by [" + userName + "] at [" + date + " " + time + "]");
                            ...
                            if (d.getRs().next())
                            {
                                ...
                                try
                                {
                                    ...
                                    if (d.getRs().next())
                                    {
                                        ...
                                        //Socket s = new Socket ("192.168.0.197", 15152);
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            //Socket s = new Socket ("192.168.0.197", 15153);
